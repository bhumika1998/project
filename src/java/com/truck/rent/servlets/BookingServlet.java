    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            }else
            {
              ...
              String trucktype=request.getParameter("tt");
              //create user object and set all rhe data to that object
             bookuser buser=new bookuser(email,name, mobile, source, destination, trucktype);
              
              //creating object of userDao
               UserDao dao=new UserDao(ConnectionProvider.getConnection());
              if(dao.bookUser(buser)){
